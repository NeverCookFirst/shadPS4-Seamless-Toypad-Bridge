...
rem shadPS4ToypadBridge.exe must sit in the SAME FOLDER as shadPS4.exe (it auto-detects it
...
rem overlay in-game.
"%~dp0shadPS4ToypadBridge.exe" "C:\path\to\games\CUSA01176\eboot.bin"
pause
